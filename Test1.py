...
material1.bumpmap = soy.textures.Bumpmap("media/grass.jpg")
...
material3.bumpmap = soy.textures.Bumpmap('media/lava.png')
material3.colormap = soy.textures.Cubemap("checkered", [red, green], 1,2)
